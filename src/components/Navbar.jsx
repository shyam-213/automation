            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center justify-end">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <a
                    href={"/Signin"}
                    className="text-sm font-medium text-gray-700 hover:text-orange-600 rounded-md px-4 py-2"
                  >
                    Log in
                  </a>
                  ...
                  <a
                    href={"/Signup"}
                    className="text-sm font-medium text-gray-700  bg-green-300 hover:bg-green-500 rounded-md px-4 py-2"
                  >
                    Create account
                  </a>
                </div>
          ...
          >
            ...
            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
              ...
              <div className="flex gap-4 w-full">
                <a
                  href={"/Signin"}
                  className="w-1/2 py-2 px-4 rounded-md border border-gray-300 font-medium text-gray-900 hover:text-orange-600 hover:bg-gray-50"
                >
                  Log in
                </a>
                <a
                  href={"/Signup"}
                  className="w-1/2 py-2 px-4 rounded-md bg-indigo-600 text-white font-medium hover:bg-indigo-700 hover:text-orange-600"
                >
                  Create account
                </a>
              </div>
