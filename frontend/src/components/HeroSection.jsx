    ...
    <>
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
          <h1 class="mb-4 text-4xl font-bold max-sm:text-4xl tracking-tight leading-none bg-clip-text bg-gradient-to-r from-indigo-500  to-sky-800 text-transparent  md:text-5xl lg:text-6xl dark:text-white"> Automate without limits with Selkey</h1>
